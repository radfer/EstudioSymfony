...
abstract class BaseClientePeer
{
    ...
    /** the column name for the domicilio_real field */
    const DOMICILIO_REAL = 'cliente.domicilio_real';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdCliente', 'Apellido', 'Nombre', 'Dni', 'DomicilioReal', 'Telefono', 'Mail', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idCliente', 'apellido', 'nombre', 'dni', 'domicilioReal', 'telefono', 'mail', ),
        BasePeer::TYPE_COLNAME => array (ClientePeer::ID_CLIENTE, ClientePeer::APELLIDO, ClientePeer::NOMBRE, ClientePeer::DNI, ClientePeer::DOMICILIO_REAL, ClientePeer::TELEFONO, ClientePeer::MAIL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_CLIENTE', 'APELLIDO', 'NOMBRE', 'DNI', 'DOMICILIO_REAL', 'TELEFONO', 'MAIL', ),
        BasePeer::TYPE_FIELDNAME => array ('id_cliente', 'apellido', 'nombre', 'dni', 'domicilio_real', 'telefono', 'mail', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdCliente' => 0, 'Apellido' => 1, 'Nombre' => 2, 'Dni' => 3, 'DomicilioReal' => 4, 'Telefono' => 5, 'Mail' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idCliente' => 0, 'apellido' => 1, 'nombre' => 2, 'dni' => 3, 'domicilioReal' => 4, 'telefono' => 5, 'mail' => 6, ),
        BasePeer::TYPE_COLNAME => array (ClientePeer::ID_CLIENTE => 0, ClientePeer::APELLIDO => 1, ClientePeer::NOMBRE => 2, ClientePeer::DNI => 3, ClientePeer::DOMICILIO_REAL => 4, ClientePeer::TELEFONO => 5, ClientePeer::MAIL => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_CLIENTE' => 0, 'APELLIDO' => 1, 'NOMBRE' => 2, 'DNI' => 3, 'DOMICILIO_REAL' => 4, 'TELEFONO' => 5, 'MAIL' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id_cliente' => 0, 'apellido' => 1, 'nombre' => 2, 'dni' => 3, 'domicilio_real' => 4, 'telefono' => 5, 'mail' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ClientePeer::DNI);
            $criteria->addSelectColumn(ClientePeer::DOMICILIO_REAL);
            ...
            $criteria->addSelectColumn($alias . '.domicilio_real');
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(ClientePeer::ID_CLIENTE);
            if ($value) {
                $selectCriteria->add(ClientePeer::ID_CLIENTE, $value, $comparison);
            } else {
