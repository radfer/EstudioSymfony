...
abstract class BaseCliente extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the domicilio_real field.
     * @var        string
     */
    protected $domicilio_real;
    ...
    /**
     * Get the [domicilio_real] column value.
     *
     * @return string
     */
    public function getDomicilioReal()
    {
        return $this->domicilio_real;
    }
    ...
    /**
     * Set the value of [domicilio_real] column.
     *
     * @param string $v new value
     * @return Cliente The current object (for fluent API support)
     */
    public function setDomicilioReal($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->domicilio_real !== $v) {
            $this->domicilio_real = $v;
            $this->modifiedColumns[] = ClientePeer::DOMICILIO_REAL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->domicilio_real = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClientePeer::ID_CLIENTE)) {
        ...
        if ($this->isColumnModified(ClientePeer::DOMICILIO_REAL)) {
            $modifiedColumns[':p' . $index++]  = '`domicilio_real`';
        }
        if ($this->isColumnModified(ClientePeer::TELEFONO)) {
            $modifiedColumns[':p' . $index++]  = '`telefono`';
        }
        if ($this->isColumnModified(ClientePeer::MAIL)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`dni`':
                        ...
                        break;
                    case '`domicilio_real`':
                        $stmt->bindValue($identifier, $this->domicilio_real, PDO::PARAM_STR);
                        break;
                    case '`telefono`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setDomicilioReal($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientePeer::DOMICILIO_REAL)) $criteria->add(ClientePeer::DOMICILIO_REAL, $this->domicilio_real);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setDomicilioReal($this->getDomicilioReal());
    ...
    public function setConsultas(PropelCollection $consultas, PropelPDO $con = null)
    {
        ...
        foreach ($consultasToDelete as $consultaRemoved) {
            $consultaRemoved->setCliente(null);
        }
     ...
     * @return PropelObjectCollection|Consulta[] List of Consulta objects
     */
    public function getConsultasJoinAbogado($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ConsultaQuery::create(null, $criteria);
    ...
    public function setExpedienteClienteAbogados(PropelCollection $expedienteClienteAbogados, PropelPDO $con = null)
    {
        ...
        foreach ($expedienteClienteAbogadosToDelete as $expedienteClienteAbogadoRemoved) {
            $expedienteClienteAbogadoRemoved->setCliente(null);
        }
    ...
    protected function doAddExpedienteClienteAbogado($expedienteClienteAbogado)
    {
        ...
        $expedienteClienteAbogado->setCliente($this);
    }
    ...
    public function removeExpedienteClienteAbogado($expedienteClienteAbogado)
    {
        if ($this->getExpedienteClienteAbogados()->contains($expedienteClienteAbogado)) {
            ...
            $expedienteClienteAbogado->setCliente(null);
        }
