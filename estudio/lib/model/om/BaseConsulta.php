...
abstract class BaseConsulta extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the id_consulta field.
     * @var        int
     */
    ...
    /**
     * Get the [id_consulta] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [id_consulta] column.
     *
    ...
    public function setIdConsulta($v)
    {
        ...
        if ($this->id_consulta !== $v) {
            $this->id_consulta = $v;
            $this->modifiedColumns[] = ConsultaPeer::ID_CONSULTA;
        }
    ...
    public function setFecha($v)
    {
        ...
        if ($this->fecha !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ConsultaPeer::FECHA;
            }
    ...
    public function setAbogadoId($v)
    {
        ...
        if ($this->abogado_id !== $v) {
            $this->abogado_id = $v;
            $this->modifiedColumns[] = ConsultaPeer::ABOGADO_ID;
        }
    ...
    public function setClienteId($v)
    {
        ...
        if ($this->cliente_id !== $v) {
            $this->cliente_id = $v;
            $this->modifiedColumns[] = ConsultaPeer::CLIENTE_ID;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[] = ConsultaPeer::DESCRIPCION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_consulta = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->fecha = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->abogado_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 5; // 5 = ConsultaPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            foreach (sfMixer::getCallables('BaseConsulta:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseConsulta:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseConsulta:save:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseConsulta:save:post') as $callable)
                {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ConsultaPeer::ID_CONSULTA;
        if (null !== $this->id_consulta) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ConsultaPeer::ID_CONSULTA . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ConsultaPeer::ID_CONSULTA)) {
            $modifiedColumns[':p' . $index++]  = '`id_consulta`';
        }
        if ($this->isColumnModified(ConsultaPeer::FECHA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha`';
        }
        if ($this->isColumnModified(ConsultaPeer::ABOGADO_ID)) {
            $modifiedColumns[':p' . $index++]  = '`abogado_id`';
        }
        if ($this->isColumnModified(ConsultaPeer::CLIENTE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`cliente_id`';
        }
        if ($this->isColumnModified(ConsultaPeer::DESCRIPCION)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_consulta`':
                        $stmt->bindValue($identifier, $this->id_consulta, PDO::PARAM_INT);
                        break;
                    case '`fecha`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setAbogadoId($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ConsultaPeer::ID_CONSULTA)) $criteria->add(ConsultaPeer::ID_CONSULTA, $this->id_consulta);
        if ($this->isColumnModified(ConsultaPeer::FECHA)) $criteria->add(ConsultaPeer::FECHA, $this->fecha);
        if ($this->isColumnModified(ConsultaPeer::ABOGADO_ID)) $criteria->add(ConsultaPeer::ABOGADO_ID, $this->abogado_id);
        if ($this->isColumnModified(ConsultaPeer::CLIENTE_ID)) $criteria->add(ConsultaPeer::CLIENTE_ID, $this->cliente_id);
        if ($this->isColumnModified(ConsultaPeer::DESCRIPCION)) $criteria->add(ConsultaPeer::DESCRIPCION, $this->descripcion);
    ...
    {
        $criteria = new Criteria(ConsultaPeer::DATABASE_NAME);
        $criteria->add(ConsultaPeer::ID_CONSULTA, $this->id_consulta);
    ...
    /**
     * Generic method to set the primary key (id_consulta column).
     *
    ...
    public function getAbogado(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAbogado === null && ($this->abogado_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAbogado->addConsultas($this);
             */
        }
    ...
    public function getCliente(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCliente === null && ($this->cliente_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCliente->addConsultas($this);
             */
        }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseConsulta:' . $name))
        {
